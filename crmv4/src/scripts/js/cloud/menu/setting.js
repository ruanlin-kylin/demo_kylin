...
if (href_url && href_url.split("html?").length == 2) {
    ...
    for (var i = 0; i < pmStr.split("&").length; i++) {
        ...
        if (str_val && str_val.split("=") != -1) {
            ...
            /*else if(str_val.split("=")[0] == "hinedFilter"){
                            hinedFilter= $.trim(str_val.split("=")[1]);
                        }else if(str_val.split("=")[0] == "hinedHeight"){
                            hinedHeight= $.trim(str_val.split("=")[1]);
                        }else if(str_val.split("=")[0] == "hinedSearch"){
                            hinedSearch= $.trim(str_val.split("=")[1]);
                        } */
...
//             var str_val = pmStr.split("&")[i];
//             if (str_val && str_val.split("=") != -1) {
//                 if(str_val.split("=")[1] == "undefined"){
//                   data[str_val.split("=")[0]]="";
//                }else{
...
//     var isShowPage = 1;
//     /* var isShowFilter=1;
// 	   var isShowSearchInput=1;
// 	   var isShowHeightButton=1;
// 	   var isShowAllSearchField=0; */
...
function initFieldSetting() {
    ...
    /* 
    if(tableSetting && (!tableSetting.isShowFilter || tableSetting.isShowFilter==0)){
    	isShowFilter=0;
    }
    if(tableSetting && (!tableSetting.isShowSearchInput || tableSetting.isShowSearchInput==0)){
    	isShowSearchInput=0;
    }
    if(tableSetting && (!tableSetting.isShowHeightButton || tableSetting.isShowHeightButton==0)){
    	isShowHeightButton=0;
    }
