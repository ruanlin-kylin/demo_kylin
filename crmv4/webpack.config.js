...
const config = {
  ...
  entry:{
    ...
    login:'./src/scripts/js/cloud/login/login.js',
    bootbox:'./src/scripts/js/jquery/bootbox.js',
    FunctionJS:'./src/scripts/js/jquery/FunctionJS.js',
    index:'./src/scripts/js/cloud/index/index.js',
    tableList:'./src/scripts/js/cloud/menu/tableList.js',
    button_form:'./src/scripts/js/cloud/menu/button_form.js'
  },
  output: {
...
// ];
var htmlArray = [
  { "_html": "index", "title": "首页", "chunks": ['main','index'] },
  { "_html": "login", "title": "登录", "chunks": ['login','main','bootbox','FunctionJS'] },
  { "_html": "cloud/menu/calendar", "title": "calendar", "chunks":['calendar'] },
  { "_html": "cloud/menu/form", "title": "form", "chunks":['form'] },
  { "_html": "cloud/menu/setting", "title": "设置", "chunks": "setting" },
  { "_html": "cloud/menu/pageLayout", "title": "自定义", "chunks": "pageLayout" },
  { "_html": "cloud/menu/tableList", "title": "列表", "chunks": ['main','tableList','button_form'] },
  { "_html": "cloud/menu/tableTeam", "title": "表格组", "chunks": "tableTeam" },
  { "_html": "cloud/menu/tableTeamDetail", "title": "表格组详情", "chunks": "tableTeamDetail" },
  { "_html": "cloud/menu/tableListAboutItem", "title": "列表2", "chunks": "tableListAboutItem" },
  { "_html": "cloud/menu/formSetting", "title": "表单设置", "chunks": "formSetting" },
  { "_html": "cloud/menu/homePage", "title": "首页", "chunks": ['home_page2','home_page_loader','home_page_common','checkTool','home_page'] },
  { "_html": "cloud/menu/tableTeamTab", "title": "页签", "chunks": "tableTeamTab" },
  { "_html": "cloud/menu/definedPageEdit", "title": "definedPageEdit", "chunks": "definedPageEdit" },
  { "_html": "cloud/menu/messageList", "title": "消息列表", "chunks": "messageList" }
];
