...
function deleteAlert(okFun, cancelFun, txt) {
  ...
  var txt = '<div id="prompt_delate"   class="modal fade modal-statu" tabindex="-1" role="dialog" data-backdrop="static">'
...
$(function () {
  ...
  $("body").on("click", ".slide-nav", function () {
    ...
    if (slideStr == "0") {
      $(".common-container .content").addClass("content-compact").css({"left":navWidth+"px"});
      $(".logo").addClass("logo-compact");
      $(".logo .new_logo").css({"width":"60px"});
      $("#sidebar").addClass("menu-compact");
      var navWidth = $("#sidebar").width();
      $(".common-container .content").css({"left":navWidth+"px"});
      $(".common-container .menu-slide").css({"left":navWidth+"px"});
      that.attr("a", "1");
    } else {
      $(".common-container .content").removeClass("content-compact").css({"left":navWidth+"px"});
      $(".logo").removeClass("logo-compact");
      $(".logo .new_logo").css({"width":"auto"});
    ...
    $("body").on("click", ".index-slide-nav", function () {
        ...
        if (slideStr == "0") {
            ...
            $(".index-logo").addClass("logo-compact").css({"width":newNavWidth+"px"});
            $(".index-logo .new_logo").css({"width":"60px"});
            ...
            $(".index-nav").addClass("menu-compact").css({"top":"40px","bottom":"0px"});
            $(".common-container .content").css({"left":newNavWidth+"px"});
            $(".common-container .menu-slide").css({"left":newNavWidth+"px"});
            $(".common-container .index-nav").css({"overflow":"visible"});
            that.attr("a", "1");
            ...
            $(".index-logo").removeClass("logo-compact").css({"width":oldNavWidth+"px"});
            $(".index-logo .new_logo").css({"width":"auto"});
            $(".index-nav .nav-list .nav-title .txt").addClass("nav_default_style").removeClass("nav_scale_style");
            $(".index-nav").removeClass("menu-compact").css({"top":"40px","bottom":"0px"});
            $(".index-sidebar").removeClass("menu-compact");
            $(".common-container .content").css({"left":oldNavWidth+"px"});
            $(".common-container .menu-slide").css({"left":oldNavWidth+"px"});
            $(".common-container .index-nav").css({"overflow":"auto"});
            that.attr("a", "0");
