(function($) {
    ...
    var MagicSuggest = function(element, options) {
        ...
        var self = {
            ...
            _processSuggestions: function(source,notSend) {
                var json = null,
                ...
                if (data !== null) {
                    ...
                    if (typeof data === "string" && !notSend) {
                        $(ms).trigger("beforeload", [ms]);
                        var queryParams = {};
                        queryParams[cfg.queryParam] = ms.input.val();
                        var params = $.extend(queryParams, cfg.dataUrlParams);
                        if(cfg.getParams){
                            var paramsObj =cfg.getParams();
                        ...
                        $.ajax($.extend({
                            ...
                            success: function(asyncData) {
                                ...
                                self._processSuggestions(json,true);
            ...
            _render: function(el) {
                ...
                if (cfg.hideTrigger === false) {
                    ...
                    ms.input.click($.proxy(handlers._onTriggerClick, this));
                    //$(".ms-sel-ctn input").bind("click",function(){dddddddddddddddddddddddddddddd
                    //    $($(this).parent().parent().find(".ms-trigger")[0]).click();
                    //});
            ...
            _sortAndTrim: function(data) {
                ...
                if (q.length > 0) {
                    ...
                    function(index, obj) {
                        ...
                        //if (cfg.matchCase === true && name.indexOf(q) > -1 || cfg.matchCase === false && name.toLowerCase().indexOf(q.toLowerCase()) > -1) { -----------------ddddddddddddddd
                        //if (cfg.matchCase === true || cfg.matchCase === false && name.toLowerCase().indexOf(q.toLowerCase()) > -1) {
